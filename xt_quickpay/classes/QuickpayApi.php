...
function log_operations($operations, $currency = ""){
	$str="<table border='0' cellspacing='8' >";
foreach($operations as $op){
	$str .= "<tr><td><b>".$op["type"]."</b></td><td align='right' >".number_format($op["amount"]/100,2,',','')." ".$currency."</td><td> <b>Quickpay info</b>: ".$op["qp_status_msg"]."</td><td> <b>Aquirer info</b>: ".$op["aq_status_msg"]."</td><td> <b>Log</b>: ".$op["created_at"].($op["fraud"]? "<b>Fraud</b>: ".json_encode($op["fraud_remarks"]) : "")."</td></tr>";
